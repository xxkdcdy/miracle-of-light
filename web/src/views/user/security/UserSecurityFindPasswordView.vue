    ...
    <ContentField>
        <div class="container justify-content-md-center text-center">
            ...
            <div class="row">
                ...
                <div class="input-group mt-3 offset-3 col-6" style="width: 50%">
                    <span class="input-group-text" id="basic-addon1">账户名称</span>
                    <input v-model="username" type="text" class="form-control" placeholder="请输入需要找回账号的用户名" aria-label="Username" aria-describedby="basic-addon1">
                </div>
                <div class="input-group mt-3 offset-3 col-6" style="width: 50%">
                    <span class="input-group-text" id="basic-addon1">邮箱验证</span>
...
export default {
    ...
    setup() {
        ...
        const send_email = () => {
            ...
            $.ajax({
                url: "https://app4460.acapp.acwing.com.cn/api/user/security/sendmail/",
                type: "post",
                data: {
        ...
        const verify_email = () => {
            $.ajax({
                url: "https://app4460.acapp.acwing.com.cn/api/user/security/findpassword/",
                type: "post",
                data: {
                    code: code.value,
